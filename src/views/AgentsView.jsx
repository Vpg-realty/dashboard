    ...
    <div className="grid grid-cols-12 gap-4 h-full">
      ...
      <Panel className="col-span-12 lg:col-span-5 min-h-0" title="Agents by Tier" subtitle="all markets" accent="Distribution">
        <ResponsiveContainer width="100%" height="100%">
          <PieChart>
            <Pie data={tiers} dataKey="value" nameKey="label" innerRadius={45} outerRadius={85} paddingAngle={3} stroke="none">
        ...
        <div className="grid grid-cols-2 gap-2 pt-2">
          {tiers.map((t) => (
            <div key={t.tier} className="flex items-center justify-between gap-2 text-xs px-2 py-1 rounded bg-zinc-950/40 min-w-0">
