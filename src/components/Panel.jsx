export default function Panel({ title, subtitle, children, accent, className = '' }) {
  return (
    <div className={`rounded-xl border border-zinc-300/80 bg-white backdrop-blur-sm flex flex-col ${className}`}>
      <div className="flex items-center justify-between px-5 py-3 border-b border-zinc-300/80">
        <div>
